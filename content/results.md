...
@confident_about
- **Confident & right:** young dogs in uncaged listing photos — the model and the outcomes agree. (Young *purebred* puppies adopt fastest of all; the caged-photo effect matters most for the much larger young, mixed-breed group.)
...
@photo_preliminary
Photo findings are preliminary. An uncaged listing photo is the clearest single effect; other composition factors (framing, pose, focus) show smaller, less consistent effects. We're re-running the image experiments with newer findings and may revise these.
...
@one_lever
**One simple change beats a fancy model.** Within young mixed-breed dogs, caged photos are associated with **{caged}** in 30-day adoption. *From our experiments.*
